...
export const categoryConfig: Record<string, CategoryConfig> = {
  ...
  obelisk_free: { label: 'Obelisks · Free', group: 'Locations', icon: 'obelisk', color: '#77bca4' },
  obelisk_combat: { label: 'Obelisks · Combat', group: 'Locations', icon: 'obelisk', color: '#c98568' },
  obelisk_locked: { label: 'Obelisks · Locked', group: 'Locations', icon: 'obelisk', color: '#9886bd' },
